...
internal static class HeadlessCiHarness
{
    ...
    private static async Task RunFlowContractAsync(MainWindow window)
    {
        ...
        // Critical physical-behavior gate: use the visible production entry and real Button.Click events
        // for book type and Quantity -> Instructions before running the broader structural contracts.
        await SingleWindowNativeClickContract.RunAsync(window);
