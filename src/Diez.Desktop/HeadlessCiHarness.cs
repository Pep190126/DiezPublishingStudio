...
internal static class HeadlessCiHarness
{
    ...
    private static void AttachRealUiModules(MainWindow window)
    {
        ...
        // Keep headless startup aligned with production: the AvaloniaEdit overlay bridge is intentionally
        // outside the startup-critical path. Native TextBoxes are the authoritative editable controls.
