...
public sealed class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            // Optional enrichments may extend native pages, but no essential editor depends on them.
            ...
            if (!StartupDiagnostics.TryAttach("Prompt Compiler 3.4", () => SingleWindowPromptTargetAiUi.Attach(mainWindow), out var promptTargetError) && promptTargetError is not null)
